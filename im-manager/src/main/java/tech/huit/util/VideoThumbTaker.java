...
public class VideoThumbTaker {
     ...
     */
    public void getThumb(String videoFilename, String thumbFilename, Integer width,
                         Integer height, int hour, int min, float sec) throws IOException,
            InterruptedException {
        ProcessBuilder processBuilder = null;
        if (null != width && null != height) {
            processBuilder = new ProcessBuilder(ffmpegApp, "-y",
