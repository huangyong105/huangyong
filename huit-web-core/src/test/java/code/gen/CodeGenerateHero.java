...
public class CodeGenerateHero {
    private static final String PROJECT_PATH = "/Users/huit/work/hplsdk";
    //    private static final String PROJECT_PATH = "C:\\work\\git\\uuc-git\\";//pc
    private static final String PROJECT_NAME = "uuc";
    private static final String SRC_PATH = "/src/main/java/";
    private static final String BASE_PACKAGE = "org.jar.hplsdk.dc.dto.rank";
    private static final String MODULE = "";
    private static final String MAPPER_PACKAGE = BASE_PACKAGE;
    private static final String MAPPER_SAVE_PATH = PROJECT_PATH;
    private static final String ENTITY_PACKAGE = BASE_PACKAGE + MODULE;
    private static final String ENTITY_SAVE_PATH = PROJECT_PATH;
    private static final String SERVICE_PACKAGE = BASE_PACKAGE + MODULE;
    private static final String SERVICE_SAVE_PATH = PROJECT_PATH + PROJECT_NAME + "-dao\\" + SRC_PATH + SERVICE_PACKAGE;
    public static final String url = "jdbc:mysql://10.0.6.200:3306/hplsdk?useUnicode=true&characterEncoding=utf-8";
    public static final String username = "root";
    public static final String password = "pwdRoot";
    public static final String tableName = "fc_rank_week";

//    private static final String BASE_MAPPER_CLASS = "org.jar.hplsdk.dc.dao.AbstractMapper";//不用修改
    private static final String BASE_SERVICE_CLASS = "tech.huit.service.AbstractService";//不用修改
    public static final String tableNamePrefix = "";// 数据库表名的前缀，比如前缀设置为t，那么t_user将会生成User.java
    ...
    private static final String MAPPER_CLASS_NAME = ENTITY_CLASS_NAME.replace("Bean", "") + "Mapper";
...
//        generateFile(s4, SERVICE_SAVE_PATH, ENTITY_CLASS_NAME + "Service.java");
    ...
    public static String generateEntity() {
        try {
            ...
            sb.append("public class " + ENTITY_CLASS_NAME + " { \n");
