...
public class SignUtils
{
	...
	public  static String signRequest (String appKey, HttpServletRequest request) {
		...
		return markSignFlag(appKey,paramsMap);
	}
...
//	protected static final char[] HEX_DIGITS_UPPER = "0123456789ABCDEF".toCharArray();
	...
	public static   String  UUID  () {
		int machineId = new Random().nextInt(1000);//最大支持1-9个集群机器部署
	...
	public static   String  roomUUID  () {
		...
		// 4 代表长度为4
		// d 代表参数为正数型
		return "R" + String.format("%010d", hashCodeV);
	}
}
