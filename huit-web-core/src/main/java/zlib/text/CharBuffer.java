...
public class CharBuffer
{
	...
	{
		if(data==null) return append(NULL);
	...
	public CharBuffer append(boolean b)
	{
		...
		{
			if(array.length<pos+5) setCapacity(pos+CAPACITY);
			array[pos]='f';
			array[pos+1]='a';
			array[pos+2]='l';
			array[pos+3]='s';
	...
	public boolean equals(Object obj)
	{
		...
		if(cb.top!=top) return false;
		if(cb.offset!=offset) return false;
		for(int i=top-1;i>=0;i--)
		{
			if(cb.array[i]!=array[i]) return false;
		}
		return true;
	}
